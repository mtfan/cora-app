...
public class DateUtil {
    ...
    public static Date parseSimple(String str) {
        return parse(str, PATTERN_CLASSICAL_SIMPLE);
    }
    ...
    /**
     * 根据格式将指定字符串解析成日期String
     *
     * @param str     指定日期
     * @param pattern 指定格式
     * @return 返回解析后的日期
     */
    public static String parse2Str(String str, String pattern) {
        DateFormat dateFormat = new SimpleDateFormat(pattern);
        try {
            Date dateStr = dateFormat.parse(str);
     ...
     * @return
     */
    public static String dateStr2Str(String dateStr, String pattern) {
        Date date = parseSimple(dateStr);
     ...
     * @return
     */
    public static Date addDateHours(int hours) {
